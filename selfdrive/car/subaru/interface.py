...
from selfdrive.car.subaru.carstate import CarState, get_can_parser
from selfdrive.car.subaru.values import ECU, check_ecu_msgs, CAR
...
class CarInterface(object):
  ...
  def update(self, c):
    ...
    if not self.CS.main_on:
      ...
      events.append(create_event('revers    if ret.gearShifter == 'reverse':
eGear', [ET.NO_ENTRY, ET.IMMEDIATE_DISABLE]))
